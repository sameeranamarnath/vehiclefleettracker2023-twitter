...
export type GraphQLGetCommunitiesTabBarItemQueryResponse = GraphQLGetCommunitiesTabBarItemQuerySuccessResponse;
...
export type GraphQLGetFollowHostButtonQueryResponse = GraphQLGetFollowHostButtonQuerySuccessResponse;
...
export type GraphQLGetLikesResponse = GraphQLGetLikesSuccessResponse | GraphQLGetLikesErrorResponse;
...
export type GraphQLGetQuickPromoteEligibilityResponse = GraphQLGetQuickPromoteEligibilitySuccessResponse;
...
export type GraphQLGetTweetDetailResponse = GraphQLGetTweetDetailSuccessResponse | GraphQLGetTweetDetailErrorResponse;
/** GraphQL UserByRestId GET レスポンスモデル */
export type GraphQLGetUserByRestIdResponse = GraphQLGetUserByRestIdSuccessResponse;
/** GraphQL UserByScreenName GET レスポンスモデル */
export type GraphQLGetUserByScreenNameResponse = GraphQLGetUserByScreenNameSuccessResponse;
...
export type GraphQLGetUsersByRestIdsResponse = GraphQLGetUsersByRestIdsSuccessResponse;
/** GraphQL UsersVerifiedAvatars GET レスポンスモデル */
export type GraphQLGetUsersVerifiedAvatarsResponse = GraphQLGetUsersVerifiedAvatarsSuccessResponse;
/** GraphQL UserTweets GET レスポンスモデル */
export type GraphQLGetUserTweetsResponse = GraphQLGetUserTweetsSuccessResponse | GraphQLGetUserTweetsErrorResponse;
...
export type GraphQLGETEndpoint = 'articleNudgeDomains' | 'AudioSpaceById' | 'AuthenticatedUserTFLists' | 'CommunitiesTabBarItemQuery' | 'DataSaverMode' | 'FollowHostButtonQuery' | 'getAltTextPromptPreference' | 'GetUserClaims' | 'HomeLatestTimeline' | 'HomeTimeline' | 'Likes' | 'ListPins' | 'ProfileSpotlightsQuery' | 'QuickPromoteEligibility' | 'SearchTimeline' | 'TweetDetail' | 'UserByRestId' | 'UserByScreenName' | 'UserMedia' | 'UsersByRestIds' | 'UsersVerifiedAvatars' | 'UserTweets' | 'UserTweetsAndReplies';
export type GraphQLGETEndPointResponseType<T extends GraphQLGETEndpoint> = T extends 'articleNudgeDomains' ? GraphQLGetArticleNudgeDomainsResponse : T extends 'AudioSpaceById' ? GraphQLGetAudioSpaceByIdResponse : T extends 'AuthenticatedUserTFLists' ? GraphQLGetAuthenticatedUserTFListsResponse : T extends 'CommunitiesTabBarItemQuery' ? GraphQLGetCommunitiesTabBarItemQueryResponse : T extends 'DataSaverMode' ? GraphQLGetDataSaverModeResponse : T extends 'FollowHostButtonQuery' ? GraphQLGetFollowHostButtonQueryResponse : T extends 'getAltTextPromptPreference' ? GraphQLGetGetAltTextPromptPreferenceResponse : T extends 'GetUserClaims' ? GraphQLGetGetUserClaimsResponse : T extends 'HomeLatestTimeline' ? GraphQLGetHomeLatestTimelineResponse : T extends 'HomeTimeline' ? GraphQLGetHomeTimelineResponse : T extends 'Likes' ? GraphQLGetLikesResponse : T extends 'ListPins' ? GraphQLGetListPinsResponse : T extends 'ProfileSpotlightsQuery' ? GraphQLGetProfileSpotlightsQueryResponse : T extends 'QuickPromoteEligibility' ? GraphQLGetQuickPromoteEligibilityResponse : T extends 'SearchTimeline' ? GraphQLGetSearchTimelineResponse : T extends 'TweetDetail' ? GraphQLGetTweetDetailResponse : T extends 'UserByRestId' ? GraphQLGetUserByRestIdResponse : T extends 'UserByScreenName' ? GraphQLGetUserByScreenNameResponse : T extends 'UserMedia' ? GraphQLGetUserMediaResponse : T extends 'UsersByRestIds' ? GraphQLGetUsersByRestIdsResponse : T extends 'UsersVerifiedAvatars' ? GraphQLGetUsersVerifiedAvatarsResponse : T extends 'UserTweets' ? GraphQLGetUserTweetsResponse : T extends 'UserTweetsAndReplies' ? GraphQLGetUserTweetsAndRepliesResponse : never;
/** GraphQL CreateRetweet POST レスポンスモデル */
export type GraphQLPostCreateRetweetResponse = GraphQLPostCreateRetweetSuccessResponse;
/** GraphQL DeleteRetweet POST レスポンスモデル */
export type GraphQLPostDeleteRetweetResponse = GraphQLPostDeleteRetweetSuccessResponse;
/** GraphQL FavoriteTweet POST レスポンスモデル */
export type GraphQLPostFavoriteTweetResponse = GraphQLPostFavoriteTweetSuccessResponse;
...
export type GraphQLPostUnfavoriteTweetResponse = GraphQLPostUnfavoriteTweetSuccessResponse;
export type GraphQLPOSTEndpoint = 'CreateRetweet' | 'DeleteRetweet' | 'FavoriteTweet' | 'HomeLatestTimeline' | 'HomeTimeline' | 'UnfavoriteTweet';
export type GraphQLPOSTEndPointResponseType<T extends GraphQLPOSTEndpoint> = T extends 'CreateRetweet' ? GraphQLPostCreateRetweetResponse : T extends 'DeleteRetweet' ? GraphQLPostDeleteRetweetResponse : T extends 'FavoriteTweet' ? GraphQLPostFavoriteTweetResponse : T extends 'HomeLatestTimeline' ? GraphQLPostHomeLatestTimelineResponse : T extends 'HomeTimeline' ? GraphQLPostHomeTimelineResponse : T extends 'UnfavoriteTweet' ? GraphQLPostUnfavoriteTweetResponse : never;
export type GraphQLEndpoint = GraphQLGETEndpoint | GraphQLPOSTEndpoint;
export type EndPointResponseType<M extends HttpMethod, T extends RequestType, N extends GraphQLEndpoint> = T extends 'GRAPHQL' ? M extends 'GET' ? N extends GraphQLGETEndpoint ? GraphQLGETEndPointResponseType<N> : never : M extends 'POST' ? N extends GraphQLPOSTEndpoint ? GraphQLPOSTEndPointResponseType<N> : never : never : never;
